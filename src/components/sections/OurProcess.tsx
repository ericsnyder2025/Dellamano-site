  ...
  return (
    <section className="section-primary relative overflow-hidden bg-gradient-to-b from-white via-brand-accent-50 to-white">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 20% 20%, rgba(37,87,191,0.07) 0%, transparent 40%), radial-gradient(circle at 80% 80%, rgba(37,87,191,0.07) 0%, transparent 40%)",
        }}
      />
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="relative">
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent 0%, rgba(37,87,191,0.35) 10%, rgba(37,87,191,0.35) 90%, transparent 100%)",
            }}
          />
              ...
              return (
                ...
                >
                  <div className="relative w-full flex flex-col items-center">
                    {/* Floating icon badge */}
                    <div className="relative w-[72px] h-[72px] rounded-full bg-white border-2 border-brand-accent flex items-center justify-center shadow-[0_8px_24px_rgba(37,87,191,0.25)] group-hover:scale-110 group-hover:shadow-[0_12px_32px_rgba(37,87,191,0.35)] transition-all duration-300 mb-6 z-10">
                  ...
                  {i < steps.length - 1 && (
                    <div
                      aria-hidden="true"
                      className="hidden lg:flex absolute top-[24px] -right-5 w-8 h-8 rounded-full bg-brand-accent items-center justify-center shadow-[0_4px_12px_rgba(37,87,191,0.4)] z-20"
                    >
